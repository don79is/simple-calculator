...
$(document).ready(function () {
    ...
    $('.calculator').append("<input style='color: floralwhite; font-size: 1.2em;' value='0' disabled>");
    $.each(buttonArray, function (index, buttonArray) {
        $(".calculator").append($("<button>" + buttonArray.value + "</button>").attr("class", buttonArray.buttonClass).attr("type", buttonArray.type).attr("value", buttonArray.value).attr("disable", false)
        );
    });
});
